---
title: "Lesson 5: Using packages to get data"
output: 
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
playerboxscores <- load_wbb_player_box(seasons = 2022)
```
...
If you look at the data, there is one field that is a TRUE/FALSE field of who started the game. If you follow Nebraska Men's Basketball, you know that Fred Hoiberg has experimented with different starting lineups. Has Amy Williams been tinkering too?
...
The most common plays -- defensive rebounds and free throws. But if you look at basketball stats, that makes sense. There's a lot more defensive rebounds than offensive. There's a lot more missed three than made ones, typically. But as Nebraska goes further on this run, you now have the ability to get very granular data to analyze how Amy Williams and the team are doing it. 